...
Exports data from MySQL (Laragon) and prepares for PostgreSQL import
"""
...
def export_mysql_data():
    """Export all data from MySQL database"""
    ...
    try:
        ...
        print(f"📊 Total tables exported: {len([t for t in exported_data if exported_data[t]])}")
...
"""
    ...
    print("✅ PostgreSQL schema generated: postgresql_schema.sql")
    return schema_sql
...
if __name__ == '__main__':
    ...
    if data:
        ...
        print("=" * 60)
        print("\nNext steps:")
        print("1. Install PostgreSQL locally or sign up for Render")
        print("2. Create a new PostgreSQL database")
        print("3. Run: psql -U postgres -d your_db < postgresql_schema.sql")
        print("4. Run: python import_to_postgresql.py (will create this next)")
        print("=" * 60)
