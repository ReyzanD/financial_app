...
class AlternativeRecommendationCard extends StatelessWidget {
  ...
  const AlternativeRecommendationCard({super.key, required this.recommendation});
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(
                recommendation.type == RecommendationType.priceAlert ? Iconsax.discount_shape : Iconsax.location,
          ...
          Text(recommendation.description, style: GoogleFonts.poppins(color: Colors.white70, fontSize: 12)),
            ...
            children: [
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      recommendation.metadata?['location'] as String? ?? 'Lokasi tidak diketahui',
                  ...
                  const SizedBox(width: 4),
                  Text(
                    recommendation.metadata?['distance'] as String? ?? 'Jarak tidak diketahui',
                    style: GoogleFonts.poppins(color: Colors.grey[500], fontSize: 12),
                  ),
                ],
              ),
                        ...
                        if (lat != null && lng != null) {
                          try {
                            ...
                            if (await canLaunchUrl(uri)) {
                              ...
                              ErrorHandlerService.showInfoSnackbar(context, 'Membuka navigasi ke $location');
                            }
                          } catch (e) {
                            ErrorHandlerService.showErrorSnackbar(context, 'Tidak dapat membuka navigasi');
                          }
                        } else {
                          ErrorHandlerService.showWarningSnackbar(context, 'Lokasi tidak tersedia');
                        }
                      }
                    },
