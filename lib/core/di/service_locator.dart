...
Future<void> setupServiceLocator() async {
  ...
  getIt.registerLazySingleton<ObligationDataService>(
  ...
  getIt.registerLazySingleton<ApiSecurityService>(() => ApiSecurityService());
  ...
  getIt.registerLazySingleton<ChallengeDataService>(
  ...
  getIt.registerFactory<InvestmentController>(
    () => InvestmentController(repository: getIt<InvestmentRepository>()),
  );
  ...
  getIt.registerFactory<ObligationController>(
    () => ObligationController(repository: getIt<ObligationRepository>()),
  );
  ...
  getIt.registerLazySingleton<CategoryCustomizationRepository>(
    () => CategoryCustomizationRepository(),
  );
  getIt.registerFactory<CategoryController>(
    () => CategoryController(
      repository: getIt<CategoryCustomizationRepository>(),
    ),
  );
  ...
  getIt.registerFactory<CalendarController>(
    () => CalendarController(repository: getIt<CalendarRepository>()),
  );

  // ========== Map Feature (Clean Architecture) ==========
  getIt.registerLazySingleton<MapRepository>(() => MapRepository());
  getIt.registerFactory<MapScreenController>(
    () => MapScreenController(repository: getIt<MapRepository>()),
  );
  ...
  getIt.registerFactory<OnboardingController>(
    () => OnboardingController(repository: getIt<OnboardingRepository>()),
  );

  // ========== AI Budget Recommendation Feature (Clean Architecture) ==========
  getIt.registerLazySingleton<AIBudgetRepository>(() => AIBudgetRepository());
  getIt.registerFactory<AIBudgetController>(
    () => AIBudgetController(repository: getIt<AIBudgetRepository>()),
  );
  ...
  getIt.registerFactory<SettingsController>(
    () => SettingsController(repository: getIt<SettingsRepository>()),
  );

  // ========== Dashboard Feature ==========
  getIt.registerLazySingleton<DashboardRepository>(() => DashboardRepository());
  getIt.registerFactory<DashboardController>(
    () => DashboardController(repository: getIt<DashboardRepository>()),
  );
  ...
  getIt.registerLazySingleton<InvestmentDataService>(
