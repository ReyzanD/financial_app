class TransactionTemplateModel {
  ...
  factory TransactionTemplateModel.fromJson(Map<String, dynamic> json) {
    return TransactionTemplateModel(
      id:
          json['id']?.toString() ??
          json['template_id_232143']?.toString() ??
          '',
      ...
      categoryName:
          ...
          json['category_name_232143']?.toString(),
      description:
      ...
      lastUsed:
          _parseDate(json['last_used']) ??
          _parseDate(json['last_used_232143']) ??
          DateTime.now(),
      createdAt:
  ...
  factory TransactionTemplateModel.fromMap(Map<String, dynamic> map) {
    return TransactionTemplateModel(
      ...
      type:
          ...
          'expense',
      categoryId:
          map['category_id_232143']?.toString() ??
          map['category_id']?.toString(),
      categoryName:
          map['category_name_232143']?.toString() ??
          map['category_name']?.toString(),
      description:
          map['description_232143']?.toString() ??
      ...
      usageCount:
          ...
          0,
      lastUsed:
          _parseDate(map['last_used_232143']) ??
          _parseDate(map['last_used']) ??
          DateTime.now(),
      createdAt:
