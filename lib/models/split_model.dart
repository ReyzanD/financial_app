class SplitModel {
  ...
  factory SplitModel.fromJson(Map<String, dynamic> json) {
    return SplitModel(
      ...
      transactionId:
          ...
          json['transaction_id_232143']?.toString() ??
          '',
      participantName:
          json['participant_name']?.toString() ??
          json['participant_name_232143']?.toString() ??
          '',
      participantPhone:
          json['participant_phone']?.toString() ??
          json['participant_phone_232143']?.toString() ??
          '',
      amount:
      ...
      paidAmount:
          ...
          (json['paid_amount_232143'] as num?)?.toDouble() ??
          0.0,
      isSettled:
          _parseBool(json['is_settled']) ??
          _parseBool(json['is_settled_232143']) ??
          false,
      ...
      createdAt:
          ...
          DateTime.now(),
      settledAt:
          _parseDate(json['settled_at']) ??
          _parseDate(json['settled_at_232143']),
    );
  }
  ...
  factory SplitModel.fromMap(Map<String, dynamic> map) {
    return SplitModel(
      ...
      transactionId:
          map['transaction_id_232143']?.toString() ??
          map['transaction_id']?.toString() ??
          '',
      participantName:
          map['participant_name_232143']?.toString() ??
          map['participant_name']?.toString() ??
          '',
      participantPhone:
          map['participant_phone_232143']?.toString() ??
          map['participant_phone']?.toString() ??
          '',
      amount:
          ...
          0.0,
      paidAmount:
          (map['paid_amount_232143'] as num?)?.toDouble() ??
          (map['paid_amount'] as num?)?.toDouble() ??
          0.0,
      isSettled:
          _parseBool(map['is_settled_232143']) ??
          _parseBool(map['is_settled']) ??
          false,
      ...
      createdAt:
          ...
          DateTime.now(),
      settledAt:
          _parseDate(map['settled_at_232143']) ?? _parseDate(map['settled_at']),
    );
  }
