...
class RecurringTransactionRepository implements RecurringTransactionRepositoryInterface {
  ...
  RecurringTransactionRepository({ApiService? api}) : _api = api ?? getIt<ApiService>();
  ...
  @override Future<void> pauseRecurringTransaction(String id) => _api.pauseRecurringTransaction(id);
  @override Future<void> resumeRecurringTransaction(String id) => _api.resumeRecurringTransaction(id);
  @override Future<void> deleteRecurringTransaction(String id) => _api.deleteRecurringTransaction(id);
}
