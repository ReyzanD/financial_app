  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Expanded(child: Consumer<TagController>(
          builder: (context, ctrl, _) {
            ...
            if (ctrl.errorMessage != null) {
              return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('Gagal memuat tags', style: GoogleFonts.poppins(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w600)),
                const SizedBox(height: 8),
                Text(ctrl.errorMessage!, style: GoogleFonts.poppins(color: Colors.grey[500], fontSize: 14)),
                const SizedBox(height: 16),
                ElevatedButton(onPressed: ctrl.refresh, style: ElevatedButton.styleFrom(backgroundColor: DesignTokens.primaryColor), child: Text('Coba Lagi', style: GoogleFonts.poppins(color: Colors.white))),
              ]));
            }
              ...
              itemBuilder: (_, i) {
                ...
                return Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Text(tag.name, style: GoogleFonts.poppins(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w500))),
                    if (tag.usageCount > 0)
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                        decoration: BoxDecoration(color: DesignTokens.borderDark, borderRadius: BorderRadius.circular(8)),
                        child: Text('${tag.usageCount}', style: GoogleFonts.poppins(color: Colors.grey[400], fontSize: 11)),
                      ),
                  ]),
                );
              },
