...
class NetWorthRepository {
  ...
  NetWorthRepository({NetWorthService? service}) : _s = service ?? getIt<NetWorthService>();

  Future<Map<String, dynamic>> calculateNetWorth() => _s.calculateNetWorth();
  Future<bool> recordSnapshot() => _s.recordSnapshot();
  Future<List<Map<String, dynamic>>> getHistory({int limit = 30}) => _s.getHistory(limit: limit);
