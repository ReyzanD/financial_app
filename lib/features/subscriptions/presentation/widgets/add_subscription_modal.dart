...
class _AddSubscriptionModalState extends State<AddSubscriptionModal> {
            ...
            children: [
              ...
              TextFormField(
                ...
                validator:
                    (v) =>
                        (v == null || v.isEmpty)
                            ? (l10n?.name_required ?? 'Nama tidak boleh kosong')
                            : null,
              ),
                ...
                children: [
                  for (final c in ['monthly', 'yearly', 'weekly'])
                    ChoiceChip(
                      ...
                      selected: _selectedCycle == c,
                      onSelected: (_) => setState(() => _selectedCycle = c),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        l10n?.next_bill ?? 'Tagihan Berikutnya',
                        style: GoogleFonts.poppins(
                          color: DesignTokens.textSecondaryDark,
                        ),
                      ),
                      Text(
                        DateFormat('dd MMM yyyy').format(_nextRenewal),
                        style: GoogleFonts.poppins(
                          color: Colors.white,
  ...
  Future<void> _save() async {
    ...
    try {
      await getIt<SubscriptionTrackerService>().addSubscription(
        SubscriptionModel(
