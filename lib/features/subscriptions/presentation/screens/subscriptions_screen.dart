...
class _SubscriptionsScreenState extends State<SubscriptionsScreen> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => context.read<SubscriptionController>().loadData());
  }
  ...
  Widget _buildHeader(
    ...
    final totalMonthly =
        (c.summary['total_monthly'] as num?)?.toDouble() ?? 0.0;
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              Text(
                c.activeOnly ? l10n?.active ?? 'Aktif' : l10n?.all ?? 'Semua',
                style: GoogleFonts.poppins(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        CurrencyFormatter.formatRupiah(totalMonthly.toInt()),
                        style: GoogleFonts.poppins(
                          color: DesignTokens.textPrimaryDark,
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
  ...
  Widget _buildBody(
    ...
    return ListView.builder(
      ...
      itemBuilder: (ctx, i) => _buildCard(context, c.subscriptions[i], l10n),
    );
  }
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${l10n?.cycle ?? 'Siklus'}: ${_cycleLabel(sub.cycle)}',
                  style: GoogleFonts.poppins(
                    color: DesignTokens.textSecondaryDark,
                    fontSize: 12,
                  ),
          ...
          Column(
            ...
            children: [
              Text(
                CurrencyFormatter.formatRupiah(sub.cost.toInt()),
                style: GoogleFonts.poppins(
                  color: DesignTokens.textPrimaryDark,
                  fontSize: 14,
                  fontWeight: FontWeight.w600,
  ...
  Widget _buildEmpty(BuildContext context, AppLocalizations? l10n) => Center(
    child: Column(
      ...
      children: [
        ...
        Text(
          l10n?.no_subscriptions ?? 'Belum ada langganan',
          style: GoogleFonts.poppins(
            color: DesignTokens.textPrimaryDark,
            fontSize: 18,
            fontWeight: FontWeight.w600,
  ...
  Future<void> _delete(BuildContext context, SubscriptionModel sub) async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder:
          (ctx) => AlertDialog(
            ...
            content: Text(
              l10n?.delete_subscription_confirm ??
    ...
    if (confirmed == true) {
      try {
        await context.read<SubscriptionController>().deleteSubscription(sub.id);
        if (!mounted) return;
        ErrorHandlerService.showSuccessSnackbar(
          context,
          l10n?.subscription_deleted_successfully ??
