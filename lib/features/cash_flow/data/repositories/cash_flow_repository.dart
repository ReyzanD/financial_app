...
class CashFlowRepository implements CashFlowRepositoryInterface {
  ...
  @override Future<Map<String, dynamic>> getCashFlowSummary() => _s.getCashFlowSummary();
  @override Future<Map<String, dynamic>> getWeeklyCashFlowForecast({int weeks = 4}) => _s.getWeeklyCashFlowForecast(weeks: weeks);
  @override Future<List<Map<String, dynamic>>> forecastDailyCashFlow({int days = 14}) => _s.forecastDailyCashFlow(days: days);
}
