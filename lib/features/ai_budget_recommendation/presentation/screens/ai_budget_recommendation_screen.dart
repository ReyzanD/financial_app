...
class _AIBudgetRecommendationScreenState extends State<AIBudgetRecommendationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Expanded(child: Consumer<AIBudgetController>(builder: (_, ctrl, __) {
          if (ctrl.isLoading) {
          ...
          if (ctrl.error != null && ctrl.recommendation == null) {
            return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Text(ctrl.error!, style: GoogleFonts.poppins(color: Colors.white70), textAlign: TextAlign.center),
              const SizedBox(height: 16),
              ElevatedButton(
  ...
  Widget _buildSummaryCard(Map<String, dynamic> rec, AIBudgetController ctrl) {
    return Container(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(colors: [DesignTokens.primaryColor, Color(0xFF6A4C9C)], begin: Alignment.topLeft, end: Alignment.bottomRight),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Text('AI Recommendation', style: GoogleFonts.poppins(color: Colors.white70, fontSize: 12, letterSpacing: 1)),
        ]),
        const SizedBox(height: 16),
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          GestureDetector(
            ...
            child: Row(children: [
              Text(NumberFormat.currency(locale: 'id', symbol: 'Rp ', decimalDigits: 0).format((rec['total_income'] as num?)?.toDouble() ?? 0)),
        ...
        if (rec['period'] != null) Text(rec['period'].toString(), style: GoogleFonts.poppins(color: Colors.white38, fontSize: 11)),
        const SizedBox(height: 16),
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
  ...
  Widget _buildAllocationSection(Map<String, dynamic> rec, AIBudgetController ctrl) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text('Alokasi per Kategori', style: GoogleFonts.poppins(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
        ...
        return Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Text(NumberFormat.currency(locale: 'id', symbol: 'Rp ', decimalDigits: 0).format(amount), style: GoogleFonts.poppins(color: DesignTokens.primaryColor, fontSize: 14, fontWeight: FontWeight.w600)),
            ]),
            const SizedBox(height: 8),
            ClipRRect(borderRadius: BorderRadius.circular(4), child: LinearProgressIndicator(value: percentage / 100, backgroundColor: Colors.grey[800], valueColor: const AlwaysStoppedAnimation<Color>(DesignTokens.primaryColor))),
            const SizedBox(height: 6),
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text('${percentage.toStringAsFixed(1)}% dari total', style: GoogleFonts.poppins(color: Colors.grey[500], fontSize: 11)),
              if (notes != null) Text(notes, style: GoogleFonts.poppins(color: Colors.grey[600], fontSize: 10, fontStyle: FontStyle.italic)),
            ]),
          ]),
        );
      }),
  ...
  Widget _buildApplyButton(AIBudgetController ctrl) {
    return Container(
      ...
      height: 56,
      decoration: const BoxDecoration(
        gradient: LinearGradient(colors: [DesignTokens.primaryColor, Color(0xFF6A4C9C)]),
        borderRadius: BorderRadius.all(Radius.circular(16)),
      ),
      child: ElevatedButton(
        ...
        child: ctrl.isApplying
            ? const CircularProgressIndicator(color: Colors.white)
            : Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                const Icon(Iconsax.tick_circle, color: Colors.white),
                const SizedBox(width: 12),
                Text('Terapkan sebagai Budget',
  ...
  Future<void> _handleApply(AIBudgetController ctrl) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (c) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
        title: Text('Terapkan Budget?',
            style: GoogleFonts.poppins(color: Colors.white)),
        content: Text('Budget ini akan otomatis dibuat berdasarkan rekomendasi AI. Anda bisa mengeditnya nanti.',
      ...
      builder: (c) {
        return AlertDialog(
          ...
          content: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('Masukkan total pendapatan bulanan Anda',
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: const BorderSide(color: DesignTokens.primaryColor)),
              ),
            ),
            const SizedBox(height: 12),
            Text('Jumlah ini akan digunakan untuk menghitung ulang alokasi budget per kategori',
