    ...
    try {
      ...
      await db.transaction((txn) async {
        ...
        for (var tx in transactions) {
          ...
          await txn.insert('transactions_232143', txMap,
        ...
        for (var cat in categories) {
          ...
          await txn.insert('categories_232143', catMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var budget in budgets) {
          ...
          await txn.insert('budgets_232143', budgetMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var goal in goals) {
          ...
          await txn.insert('financial_goals_232143', goalMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var obligation in obligations) {
          ...
          await txn.insert('financial_obligations_232143', obligationMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var scan in receiptScans) {
          ...
          await txn.insert('receipt_scans_232143', scanMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var account in accounts) {
          ...
          await txn.insert('accounts_232143', accountMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var debt in debts) {
          ...
          await txn.insert('debts_232143', debtMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var payment in debtPayments) {
          ...
          await txn.insert('debt_payments_232143', paymentMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var sub in subscriptions) {
          ...
          await txn.insert('subscriptions_232143', subMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var tag in tags) {
          ...
          await txn.insert('tags_232143', tagMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var tt in transactionTags) {
          ...
          await txn.insert('transaction_tags_232143', ttMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var split in expenseSplits) {
          ...
          await txn.insert('expense_splits_232143', splitMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var challenge in challenges) {
          ...
          await txn.insert('challenges_232143', challengeMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var investment in investments) {
          ...
          await txn.insert('investments_232143', investmentMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var template in templates) {
          ...
          await txn.insert('transaction_templates_232143', templateMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var snapshot in netWorthHistory) {
          ...
          await txn.insert('net_worth_history_232143', snapshotMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
        ...
        for (var rate in exchangeRates) {
          ...
          await txn.insert('exchange_rates_232143', rateMap,
              conflictAlgorithm: ConflictAlgorithm.replace);
        }
      });
